...
$PY tools/test.py overlay                   # combined overlay.pdf + side-by-side.pdf across every twin
...
tests/out/diff/    side-pNN.png / overlay-pNN.png (`diff`); overlay.pdf / side-by-side.pdf (`overlay`)
```
