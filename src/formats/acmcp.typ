...
// top-right infobox (JDS logo over code/data links, keywords, contributions, and
// author contact info — acmart.dtx:5899/6724) ARE reproduced (drawn in lib.typ);
// the only approximation is the infobox's vertical anchoring (top-right corner,
// not zref against the frame bottom). See DESIGN.md "Known limitations".
