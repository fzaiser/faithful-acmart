...
TESTS: dict[str, Test] = {
    ...
    "fix-quirks-blx-test": Test(
        ...
        text_assertions=(
            ...
            Assertion(engine="typst", text="organization. Metrology Bureau Inc."),
            Assertion(engine="typst", kind="absent", text="Metrology Bureau Inc.."),
            Assertion(engine="typst", text="place. Washington, D.C."),
            Assertion(engine="typst", kind="absent", text="Washington, D.C.."),
    ...
    "fix-quirks-blx-off-test": Test(
        ...
        text_assertions=(
            ...
            Assertion(engine="typst", text="Metrology Bureau Inc., ()."),
            Assertion(engine="typst", text="Washington, D.C., ()."),
            Assertion(engine="typst", text="Standards Group Inc. . 2016."),
            Assertion(engine="typst", text="Petra Pike, (Ed.) . 2017."),
            Assertion(engine="typst", text="Widgets Inc.. 2018."),
