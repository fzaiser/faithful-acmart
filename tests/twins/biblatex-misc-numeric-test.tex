%% biblatex-misc-numeric-test - the venue-less BibLaTeX drivers under acmnumeric.
...
\addbibresource{biblatex-misc-test.bib}
\begin{document}
\thispagestyle{empty}
...
\section*{Misc, online and the types that alias to them}
