%% biblatex-names-test - biber's name filters under acmauthoryear.
...
Postnotes reach every form under acmauthoryear: \cite[p.~5]{NsAbe}, \textcite[p.~5]{NsAbe}, \citeauthor[p.~5]{NsAbe}, and \citeyear[p.~5]{NsAbe}.
