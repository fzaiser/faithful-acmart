// acmtog-pages-test — continuation-page running heads/footers.
...
#show: acmart.with(
  format: "acmtog",
  title: "An acmtog Running Head Sample",
  short-title: "TOG Heads",
  ...
  abstract: [A short abstract for a continuation-page acmtog test.],
