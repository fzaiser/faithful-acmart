...
Postnotes reach every form in author-year mode, including the two that drop them in numbers mode: #cite("jones", supplement: [p.~5]), #cite("jones", form: "prose", supplement: [p.~5]), #cite("jones", form: "author", supplement: [p.~5]), and #cite("jones", form: "year", supplement: [p.~5]).
