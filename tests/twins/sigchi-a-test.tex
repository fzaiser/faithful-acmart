...
\begin{marginfigure}
\rule{3cm}{1cm}
\caption{A margin figure caption.}
\end{marginfigure}
...
\centering
\rule{6cm}{1.5cm}
\caption{A sigchi-a caption, set bold at the small size, long enough that it
wraps onto a second line for the typography comparison.}
\end{figure}

\begin{figure*}[h]
\centering
\rule{\fulltextwidth}{1cm}
\caption{A full-text-width figure spanning the text plus the margin column via
\texttt{fulltextwidth}.}
\end{figure*}
