%% biblatex-fields-numeric-test - BibLaTeX field formats under acmnumeric.
...
A report that was always a report gets none \cite{TyReportNone}, and free text is printed as it stands \cite{TyFree}, including a value the \emph{.bst} backend would read as a missing-value marker \cite{TyMarker}.
