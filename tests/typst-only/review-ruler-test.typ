// review-ruler-test — the review/authordraft line-number ruler belongs to the
...
// own, so every number on the page is a ruler number: this document suppresses
// the head and must show none, while review-ruler-on-test keeps it and shows
// them. Titleless because a title block pins page one's chrome before a body
// `set page` reaches it.
