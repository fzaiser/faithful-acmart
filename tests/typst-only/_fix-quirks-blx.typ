...
#let blx-keys = (
  ...
  "FxMiscNoDate", "FxMiscNoDateBare", "FxMiscNoDatePunct", "FxMiscNoDatePlace",
...
#let blx-body = [
  ...
  An undated entry whose organization or location already ends in a period #cite("FxMiscNoDatePunct", "FxMiscNoDatePlace").
